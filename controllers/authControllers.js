...
const UsersDatas = require('../models/User');
...
const register = async (req, res) => {
    ...
    try {
        ...
        let user = await UsersDatas.findOne({ $or: [{ username: uppercaseUsername }, { email }] });
...
const login = async (req, res) => {
    ...
    try {
        ...
        const user = await UsersDatas.findOne({
...
const forgotPassword = async (req, res) => {
    ...
    try {
        const user = await UsersDatas.findOne({ email });
